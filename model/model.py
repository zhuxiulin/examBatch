...
class Information_model(Model):
    ...
    __insertable__ = set({'exam_ex_id','sg_id','in_score','in_ip','in_endtime','in_state','class_cl_id','student_st_id','in_temp_ip'})
    __updateable__ = set({'exam_ex_id','sg_id','in_score','in_ip','in_endtime','in_state','class_cl_id','student_st_id','in_temp_ip'})
